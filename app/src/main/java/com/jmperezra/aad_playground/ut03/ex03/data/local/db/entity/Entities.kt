...
import com.jmperezra.aad_playground.ut03.ex03.domain.FileModel

@Entity(tableName = "alerts")
data class AlertEntity(
    @PrimaryKey @ColumnInfo(name = "id") val alertId: Int,
    val title: String,
    val type: Int,
    val summary: String,
...
data class FileEntity(
    ...
    companion object {
        fun toEntity(alertId: Int, fileModel: FileModel) =
